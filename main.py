def create_dealer_card(first: bool, num: number):
    global card_number, dealer_ace, dealer_card, _10_j_q_k, hidden_dealer_card
    if first == False:
        ...
        dealer_card.set_velocity(-2000 + 20 * num, 0)
        pause(200)
        dealer_card.set_velocity(0, 0)
        dealer_card.set_position(80 + 20 * num, 27)
        pause(100)
    else:
        card_number = card_number_list[randint(0, 12)]
        ...
        if first:
            ...
            hidden_dealer_card.set_velocity(-2000, 0)
            pause(200)
            hidden_dealer_card.set_velocity(0, 0)
            hidden_dealer_card.set_position(80, 27)
...
def draw_cards():
    global player_sum, draws, player_ace
...
def dealer_draw_cards():
    global dealer_sum, dealer_draws
    while True:
        if dealer_sum < player_sum or dealer_sum == player_sum and dealer_sum < 14:
        ...
        pause(100)
def start_game():
    global can_start_game, player_sum, dealer_sum, draws, dealer_draws
    if can_start_game:
